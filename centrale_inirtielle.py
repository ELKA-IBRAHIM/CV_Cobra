...
UNIT_SEL=0x3B
PWR_MODE=0x3E
ADRESS_BNO055=0x28 #adresse 7 bits du BONOBO055
HEADING=0x1A
MODE_REG=0x3D
FUSION_MODE=0x0C
UNIQUE_ID=0x50
...
Centrale = BNO055(i2cbus)

def mesure_angles():
        data = Centrale.read_euler()
        return (data["pitch"], data["roll"], data["heading"]) #tangade roulis lacet 